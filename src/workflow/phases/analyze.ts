...
export async function runAnalyzePhase(
	...
	const analyzerTask = [
		...
		"",
		"## Skeleton",
		"A file/symbol map is provided via the MCP get_issue/get_issue_comments tools.",
		"To investigate, use the glob, grep, and read tools against the worktree (per repo-triage).",
		"Do NOT invent or call nonexistent tools (e.g. list, dir_list, fz_join). Use only the tools",
		"listed in your available toolset. If you need a specific file's full content, read it",
		"",
